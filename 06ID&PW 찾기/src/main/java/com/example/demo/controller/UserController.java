...
public class UserController {
    ...
    public @ResponseBody String findId_post(@RequestParam(value = "username") String username, @RequestParam(value = "nickname") String nickname, @RequestParam(value = "phone") String phone) throws Exception {
