...
public class UserController {
    ...
    public @ResponseBody String findId_post(@RequestParam(value = "nickname") String nickname, @RequestParam(value = "phone") String phone) throws Exception {
        log.info("POST /user/findId " + nickname + " | " + phone);
        // 유효성 체크(생략)

        // 서비스 실행(nickname, phone이 일치하는 username 찾기)
    ...
    @ResponseBody
    public ResponseEntity<JSONObject> findId_post(@RequestParam(value = "username") String username, @RequestParam(value = "nickname") String nickname, @RequestParam(value = "phone") String phone) throws Exception {
        log.info("POST /user/findPw " + username + " | " + nickname + " | " + phone);
        // 유효성 체크(생략)
